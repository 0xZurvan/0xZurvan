...
function FirstRow() {
  return (
    <div className="xl:w-full lg:w-full md:full flex flex-row justify-center items-center gap-2 md:space-x-20 xl:space-x-20 lg:space-x-20 mt-8">
...
function SecondRow() {
  return (
    <div className="xl:w-full lg:w-full md:full flex flex-row justify-center items-center gap-2 md:space-x-20 xl:space-x-20 lg:space-x-20">
      <div className="flex flex-col items-center justify-evenly gap-2">
...
export default function Skills() {
  return (
    <div className="xl:w-full lg:w-full md:w-full flex flex-col justify-center items-center xl:items-start xl:justify-center lg:items-start space-y-2 my-8 divide-y divide-green/30">
      ...
      <div className="xl:w-full lg:w-full md:w-full grid grid-cols-1 items-center justify-evenly space-y-8">
        <FirstRow />
        <SecondRow />
      </div>
    </div>
