...
function SubmittedSuccessfully() {
  return (
    <div className='flex flex-col justify-center items-center gap-4 my-44'>
      <h2 className='font-oswald font-medium text-green text-xl text-center'>Submitted Successfully!</h2>
      <p className='font-oswald font-thin text-white text-base text-center'>Thank you so much for leaving a message, talk you soon!</p>
    </div>
  )
}
    ...
    <div className="container mx-auto">
      <div className="p-5 space-y-5">
        ...
        <form className="grid grid-cols-2 gap-5">
          ...
          ></textarea>
          <button 
          className="rounded-lg focus:outline-none mt-5 bg-green hover:bg-darkGreen px-4 py-2 text-main hover:text-white font-bold font-oswald w-full"
          type="submit"
          onClick={onSubmit}
          >
