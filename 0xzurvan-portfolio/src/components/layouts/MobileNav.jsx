...
function Icons() {
  return (
    <div className="flex flex-row justify-center gap-4 my-8">
      ...
      <a href="https://discord.com/users/823992612028940319" target="_blank">
...
function Text() {
  return (
    <div className="m-4 space-y-3">
      <h1 className="text-white text-2xl font-bold font-oswald text-center">
        0xZurvan
      </h1>
...
function LinkLayout({ page, name }) {
  return (
    ...
    md:w-80
    h-12
    hover:bg-main hover:bg-opacity-40 hover:border-0 border-b-2 border-main"
    >
      <Link
        to={page}
    ...
    <div>
      ...
      "
        >
          <button
            onClick={onClick}
            className="relative bottom-6 left-48 md:left-64"
          >
